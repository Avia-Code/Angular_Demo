  ...
  prevImg(x) {
    ...
    const int = setInterval(() => {
      ...
      if (x <= -100) {
        ...
        newPrev.style.textAlign = 'center';
        ...
        const thinkBlockHeader = document.createElement('div');
        thinkBlockHeader.classList.add('think_block_header');
        thinkBlockHeader.style.display = 'flex';
        thinkBlockHeader.style.alignItems = 'center';
        thinkBlockHeader.style.justifyContent = 'space-between';

        const thinkBlockText = document.createElement('div');
        thinkBlockText.classList.add('think_block_text');
        thinkBlockText.classList.add('mobile');
        thinkBlockText.style.textAlign = 'center';
